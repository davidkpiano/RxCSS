...
function RxCSS(observableMap) {
  ...
  var value$ = _observable2.default.merge.apply(_observable2.default, _toConsumableArray(Object.keys(observableMap).map(function (key) {
  ...
  var style$ = new _subject2.default();

  value$.subscribe(function (value) {
    styledash(target).set(value);
    style$.next(value);
  });
